...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0F1E] dot-bg flex">
      ...
      >
        <div className="absolute inset-0 border-r border-slate-800/60" />
        <div className="relative text-center max-w-md">
          ...
          <motion.div
            ...
            className="glass rounded-2xl p-6 border border-indigo-500/20 mb-6 text-left"
          >
            <div className="flex items-center justify-between mb-4">
              <span className="text-xs text-slate-400 font-medium">Analysis Complete</span>
            ...
            <div className="flex items-center gap-4">
              <div className="relative w-16 h-16">
                <svg viewBox="0 0 36 36" className="w-16 h-16 -rotate-90">
                  ...
                  <circle cx="18" cy="18" r="15.5" fill="none" stroke="#10B981" strokeWidth="3"
                    strokeDasharray="97.4" strokeDashoffset="9.7" strokeLinecap="round" />
                </svg>
              ...
              <div>
                <div className="text-base font-bold text-white mb-0.5">Mostly Credible</div>
                <div className="text-xs text-slate-500">Low bias · Low scam risk</div>
              </div>
            </div>
          </motion.div>

          <h2 className="text-2xl font-bold text-white mb-3">Verify every story.</h2>
          <p className="text-slate-500 text-sm leading-relaxed">
            Join 50,000+ journalists and fact-checkers who trust TruthLens to surface the truth.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-500">Sign in to continue verifying news</p>
          </div>

          {/* Google button */}
          <button
            onClick={() => {}}
            className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl border border-slate-700/60 bg-slate-900/40 hover:bg-slate-800/60 transition-all text-sm font-medium text-slate-300 mb-6 group"
          >
            <svg viewBox="0 0 24 24" className="w-4.5 h-4.5" style={{ width: '18px', height: '18px' }}>
          ...
          <div className="flex items-center justify-between mb-8">
            <label className="flex items-center gap-2 cursor-pointer group">
              <input type="checkbox" className="w-4 h-4 rounded border-slate-700 bg-slate-900 accent-indigo-500" />
